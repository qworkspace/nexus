        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center justify-between text-xs text-zinc-600">
              ...
              <span className={costs.withinBudget ? "text-zinc-600" : "text-red-600"}>
          ...
          <div className="pt-3 border-t border-zinc-200">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className={`font-semibold ${costs.withinBudget ? "text-zinc-600" : "text-red-600"}`}>
                {formatCurrency(costs.projection)}
              </span>
            </div>
            <p className={`text-xs mt-1 flex items-center gap-1 ${costs.withinBudget ? "text-zinc-600" : "text-red-600"}`}>
