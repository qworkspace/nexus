...
export function ModelIntelligenceDashboard() {
  ...
  const getModelBadgeColor = (model: string): string => {
    if (model.includes('opus')) return 'bg-zinc-100 text-zinc-700 border-zinc-300';
    if (model.includes('sonnet')) return 'bg-zinc-100 text-zinc-700 border-zinc-300';
    if (model.includes('haiku')) return 'bg-zinc-100 text-zinc-700 border-zinc-300';
    if (model.includes('glm')) return 'bg-yellow-100 text-yellow-700 border-yellow-200';
    if (model.includes('gpt')) return 'bg-zinc-100 text-[#FFE135] border-zinc-300';
