  ...
  if (loading) {
    return (
      <div className="p-6 max-w-7xl">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">Governance</h1>
          <p className="text-zinc-500 text-sm">Enterprise agent oversight and control</p>
        </div>
        <div className="grid grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-zinc-100 dark:bg-zinc-800 rounded-xl h-32 animate-pulse" />
          ))}
        </div>
      </div>
    );
    ...
    return (
      <div className="p-6 max-w-7xl">
        ...
        <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-100 mb-2">No governance data available</h3>
          <p className="text-zinc-500">Agent activity will appear here once actions are logged.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 max-w-7xl">
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4">
          <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Active Agents</p>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4">
          <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Runs Today</p>
          <div className="flex items-center gap-2 mt-2">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4">
          <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Avg Success Rate</p>
          <span className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 mt-2 inline-block">
            {(data.summary.avgSuccessRate * 100).toFixed(1)}%
          </span>
        </div>

        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4">
          <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Cost Today</p>
          <span className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 mt-2 inline-block">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 mb-8">
        <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-4">Agent Success Rates (7 Days)</h3>
