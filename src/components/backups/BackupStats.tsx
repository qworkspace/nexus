    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-zinc-50 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`text-sm font-semibold ${hasIssues ? 'text-yellow-600' : 'text-zinc-600'}`}>
          ...
          <div className="h-2 bg-zinc-200 rounded-full overflow-hidden mb-2">
            <div
              className={`h-full transition-all duration-500 ${
                healthPercentage === 100 ? 'bg-zinc-800' :
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-zinc-50 border border-zinc-300 rounded-lg p-3">
