...
const AGENT_COLORS = {
  cipher: { bg: 'bg-zinc-100', text: 'text-zinc-700', border: 'border-zinc-200' },
  spark: { bg: 'bg-zinc-100', text: 'text-zinc-700', border: 'border-zinc-200' },
  flux: { bg: 'bg-zinc-100', text: 'text-zinc-700', border: 'border-zinc-200' },
};
