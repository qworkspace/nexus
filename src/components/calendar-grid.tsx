...
const jobColors: Record<string, string> = {
  "morning-brief": "bg-zinc-100 border-zinc-300 text-zinc-800",
  "morning-mode": "bg-zinc-100 border-zinc-300 text-zinc-800",
  "discord-digest-morning": "bg-zinc-100 border-zinc-300 text-zinc-800",
  "discord-digest-evening": "bg-zinc-100 border-zinc-300 text-zinc-800",
  "night-mode": "bg-zinc-100 border-zinc-300 text-zinc-800",
  "dj-discovery": "bg-zinc-100 border-zinc-300 text-zinc-800",
};
