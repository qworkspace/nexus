  ...
  return (
    <div
      ...
      className={`
        ...
        ${isSelected ? "ring-2 ring-blue-500 border-zinc-500" : "border-zinc-200"}
      `}
    >
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-semibold text-zinc-900">{agent.id}</h3>
        <span className="text-xs bg-zinc-100 px-2 py-1 rounded text-muted-foreground">
          {agent.type}
        </span>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="font-medium text-zinc-900">{agent.totalRuns}</span>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-medium text-zinc-900">{(agent.avgDuration / 1000).toFixed(1)}s</span>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-medium text-zinc-900">${agent.costPerSuccess.toFixed(4)}</span>
        </div>
      </div>
    </div>
  );
