  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <BarChart data={formattedData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
        ...
        />
        <Bar dataKey="input" stackId="1" fill="#8b5cf6" radius={[4, 4, 0, 0]} name="Input" maxBarSize={40} />
        <Bar dataKey="output" stackId="1" fill="#3b82f6" radius={[4, 4, 0, 0]} name="Output" maxBarSize={40} />
        <Bar dataKey="cacheRead" stackId="1" fill="#10b981" radius={[4, 4, 0, 0]} name="Cache Read" maxBarSize={40} />
      </BarChart>
    </ResponsiveContainer>
  );
}
